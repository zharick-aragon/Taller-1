...
{
    private static final double CANTIDAD_CORRIENTE = 50.0;
    ...
    {
        assertEquals( CANTIDAD_CORRIENTE, tipoCorriente.getCantidadDisponible( ), 0.001, "La cantidad inicial no es correcta" );
        try
        {
        ...
        assertEquals( CANTIDAD_CORRIENTE - CANTIDAD_VENTA, tipoCorriente.getCantidadDisponible( ), 0.001, "La cantidad actualizada no es correcta" );
    }
    ...
    void testDespacharGasolinaOkVarios( )
    {
        ...
        assertEquals( CANTIDAD_CORRIENTE - ( 3 * CANTIDAD_VENTA ), tipoCorriente.getCantidadDisponible( ), 0.001, "La cantidad actualizada no es correcta" );
    }
    ...
    void testDespacharGasolinaInsuficiente( )
    {
        ...
        assertEquals( CANTIDAD_CORRIENTE - ( 3 * CANTIDAD_VENTA ), tipoCorriente.getCantidadDisponible( ), 0.001, "La venta fallida no debió actualizar el inventario de gasolina" );
    }
